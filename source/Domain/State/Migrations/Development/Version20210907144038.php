...
final class Version20210907144038 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE data_wiz_user DROP keycloak_uuid, CHANGE roles roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE data_wiz_user ADD keycloak_uuid BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', CHANGE roles roles LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_bin`');
